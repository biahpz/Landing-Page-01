...
(() => {
    ...
    pointerLight.className =
        "dream4-pointer-light";
    ...
    if (
        ...
        reflection.className =
            "dream4-bottle-reflection";


        heroProduct4.appendChild(
            reflection
        );
    ...
    /* =====================================================
       GLOW BURST EM CLIQUES IMPORTANTES
    ===================================================== */

    const burstSelectors = [
    ...
    function updateDream4GalleryDepth() {

        if (
            !galleryTrack4 ||
            !galleryItems4.length
        ) {
    ...
    galleryTrack4?.addEventListener(
        "scroll",
        updateDream4GalleryDepth,
        {
            passive:
                true
        }
    ...
    campaign4?.addEventListener(
        ...
        event => {
            ...
            if (
                ...
                campaignImage4.style.transform = `
    ...
    function updateDream4Performance() {
        ...
        if (
            ...
            d4Root.style.setProperty(
                "--dream4-aurora-opacity",
                "0.35"
            );


            d4Root.style.setProperty(
                "--dream4-shine-opacity",
                "0.18"
            );
    ...
    isSmallScreen.addEventListener?.(
        "change",
        updateDream4Performance
    );
