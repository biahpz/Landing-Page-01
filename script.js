...
const scenes = {
    ...
    romance: {
        ...
        text:
            "Uma atmosfera delicada, envolvente e apaixonante.",
    ...
    flores: {
        ...
        text:
            "Vibrante, moderna e perfeita para momentos que ficam na memória.",
    ...
    energia: {
        ...
        text:
            "Leve, confortável e tranquilo para desacelerar.",

        background:
            `
            radial-gradient(
                circle at 20% 50%,
                rgba(69, 196, 170, 0.28),
                transparent 38%
            ),
            radial-gradient(
                circle at 80% 40%,
                rgba(82, 133, 197, 0.28),
                transparent 42%
            ),
            linear-gradient(
                135deg,
...
/* CORREÇÃO IMPORTANTE:
   o listener só é criado depois das declarações acima */
